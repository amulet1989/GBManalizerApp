function[bwClases,bwActivo,bwNecro,bwEdema,t]=Segementation_pixelXpixel(bwGlioma3D,bwActivo3D,bwnecroEd3D,T1C,T2,T1,Flair,Mynet,PS1)
...
%% Random Forest
Matriz_clases=predict(Mynet,Matriz_rasgos');%mynet->NN  MdlRF -> Random Forest
